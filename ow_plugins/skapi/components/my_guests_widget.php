 ...
 * @since 1.3.1
 */
class SKAPI_CMP_MyGuestsWidget extends BASE_CLASS_Widget {
    ...
    public function __construct(BASE_CLASS_WidgetParameter $params) {
        ...
        if ($total > $count) {
            $toolbar = array(
                ...
                'href' => OW::getRouter()->urlForRoute('skapi.list')
            );
    ...
    public static function getSettingList() {
        ...
        $settingList['count'] = array(
            'presentation' => 'number',
            'label' => OW::getLanguage()->text('skpi', 'guest_list_widget_settings_count'),
            'value' => '6'
        );
    ...
    public static function getStandardSettingValueList() {
        return array(
            ...
            self::SETTING_TITLE => OW::getLanguage()->text('skpi', 'viewed_profile')
        );
    }
