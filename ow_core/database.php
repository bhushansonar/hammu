...
final class OW_Database {
    ...
    private function __construct($params) {
        ...
        try {
            ...
            $this->connection = new PDO($dsn, $params['username'], $params['password'], array(MYSQL_ATTR_INIT_COMMAND => 'SET NAMES UTF8',
    ...
    function updateObjectCustom($tableName, $obj, $primaryKeyName = 'id', $lowPriority = false, $field, $value) {
        ...
        if ($obj != null && is_object($obj)) {
            ...
            $sql = "UPDATE" . ($lowPriority ? " LOW_PRIORITY" : "") . " `{$tableName}` SET $field=:$value WHERE {$primaryKeyName}=:{$primaryKeyName}";
