...
function advance_search() {
    ...
    if (!empty($output->results[0]->geometry->location->lng)) {
        ...
        $data_arr = array(
            ...
            "field_e176592928a5e895d73cc5affbf87919" => $lady_name,
            "MainSearchFormSubmit" => "Search"
        );
...
function getAllServicesOrPreferences() {
    ...
    $filed_array = array('field_b63db9264225396873b5b6e9a02dbc66', 'field_e9795a9d3be797f58aab38b1033265a4');
...
function getAllServices() {
    ...
    $filed_array = array('field_b63db9264225396873b5b6e9a02dbc66');
...
//    $user_id = $app->request()->params('user_id');
//
//    $filed_array = array('username', 'birthdate', 'email', 'googlemap_location', 'preferences_or_service');
//    $data = array();
...
//            if (!empty($value)) {
//                if ($key = "preferences_or_service") {
//
//                    $key_value = "field_e9795a9d3be797f58aab38b1033265a4";
//                } else {
//                    $key_value = $key;
//                }
//                $question = $QuestionService->findQuestionByName($key_value);
//                switch ($question->presentation) {
//                    case $QUESTION_PRESENTATION_RANGE :
//                    case $QUESTION_PRESENTATION_BIRTHDATE :
//                    case $QUESTION_PRESENTATION_AGE :
