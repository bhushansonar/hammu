...
class BASE_CTRL_Join extends OW_ActionController {
    ...
    public function index($params) {
        ...
        //include js
//bhushan changes
//        $skapiJsDir = OW::getPluginManager()->getPlugin("skapi")->getStaticJsUrl();
//        OW::getDocument()->addScript($skapiJsDir . "custom.js");
//end bhushan changes
...
//                print_r($_SESSION);
//                echo '</pre>';
                ///hardik patch for services
                if (!empty($_SESSION["joinData"][HAMMU_DB_IM_USING_HAMMU_AS_KEY]) && $_SESSION["joinData"][HAMMU_DB_IM_USING_HAMMU_AS_KEY] == 1) {
                    if ($question['realName'] == HAMMU_DB_SERVICES_KEY) {
                        $question['realName'] = HAMMU_DB_PREFRENCES_KEY;
                    }
                }
                // echo "<br/>--> " . $question['realName'];
                //field_f2d8bb949d7d74a70bcb2003abc5b436 - Search Preferences (CLIENT)
                //field_f92bbdb57510b86ba6c506c487be3aa1 - services (ESCORT)
                //echo " name-> " . OW::getLanguage()->text('base', "questions_question_field_f92bbdb57510b86ba6c506c487be3aa1_label");
                //if()
