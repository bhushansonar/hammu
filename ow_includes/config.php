...
//define('OW_URL_HOME', 'http://www.hammu.dating/hammu/');
define('OW_URL_HOME', 'http://localhost/hammu/');
//define('OW_DB_HOST', 'db575430796.db.1and1.com');
//define('OW_DB_PORT', null);
//define('OW_DB_USER', 'dbo575430796');
//define('OW_DB_PASSWORD', 'admin123@');
//define('OW_DB_NAME', 'db575430796');
define('OW_DB_HOST', 'localhost');
define('OW_DB_PORT', null);
define('OW_DB_USER', 'root');
define('OW_DB_PASSWORD', '');
//define('OW_DB_NAME', 'db577952659');
//define('OW_DB_NAME', 'hammu_latest');
define('OW_DB_NAME', 'hammu_live');
...
define('OW_PASSWORD_SALT', '552fc957e8f30');
